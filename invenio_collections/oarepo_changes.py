...
features_incorporated = '[{"name":"alembic-dependency-communities","base":"v1.0.0"}]'

oarepo_major_version = "13"

package_oarepo_version = "oarepo-0.5.0"

configuration = '{"name": "invenio-collections", "oarepo": 13, "features": [{"name": "alembic-dependency-communities", "base": "v1.0.0"}], "package": "invenio-collections", "invenio_version": "0.5.0", "version": "0.5.0"}'
